  ...
  return (
    ...
    <form className='flex flex-wrap w-full items-start justify-between'>
        ...
        <div className='w-1/2 '>
            ...
            <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] mb-4' type="text" placeholder='Make A UI Design' />
            ...
            <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] mb-4' type="text" placeholder='dev/design/etc'/>
